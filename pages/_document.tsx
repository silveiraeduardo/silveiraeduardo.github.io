      ...
      <Html lang="pt-br">
        <Head>
          <meta
            ...
            content="default-src 'self' ; script-src 'self' 'unsafe-eval' 'unsafe-inline' *.eduardosilveira.com *.googletagmanager.com; style-src 'self' 'unsafe-inline' googletagmanager.com *.googleapis.com *.eduardosilveira.com; img-src 'self' data: https: http: ; media-src 'self' ; frame-src eduardosilveira.com googletagmanager.com;"
          />
